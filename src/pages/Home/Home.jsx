...
return (
    <div>
        ...
        <div className="container mx-auto px-4 my-[120px]">
            <h1 data-aos="fade-right" className={`text-2xl md:text-3xl lg:text-4xl font-semibold text-orange-400 `}>Shop by Category. <span className="text-[#6B7280]">Find Your Style, Explore Our Diverse Range of Products.</span></h1>
