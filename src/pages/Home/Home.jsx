    ...
    return (
        <div>
            ...
            <div className="container mx-auto px-4 my-[120px]">
                <h1 className={`text-2xl md:text-3xl lg:text-4xl font-semibold text-orange-400 `}>Shop by Category. <span className="text-[#6B7280]">Find Your Style, Explore Our Diverse Range of Products.</span></h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-12">
                    <div className="bg-sky-50 rounded-xl p-7 lg:pr-0">
                        <div className="flex flex-col-reverse items-center lg:flex-row w-full lg:justify-between gap-6 lg:gap-0 min-h-[250px]">
                            ...
                            <div className="h-[300px] lg:h-full lg:w-1/2">
                                <img src="https://i.ibb.co/6v304kx/New-Mockups-no-hanger-TShirt-Yellow-transformed.png" alt="t-shirt" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                    <div className="bg-lime-50 rounded-xl p-7 lg:pr-0">
                        <div className="flex flex-col-reverse items-center lg:flex-row w-full lg:justify-between gap-6 lg:gap-0 min-h-[250px]">
                            ...
                            <div className="h-[300px] lg:h-full lg:w-1/2">
                                <img src="https://i.ibb.co/RCqnC0k/istockphoto-1350560575-170667a-transformed.png" alt="Shoes" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                    <div className="bg-purple-50 rounded-xl p-7 lg:pr-0">
                        <div className="flex flex-col-reverse items-center lg:flex-row w-full lg:justify-between gap-6 lg:gap-0 min-h-[250px]">
                            ...
                            <div className="h-[300px] lg:h-full lg:w-1/2">
                                <img src="https://i.ibb.co/dgHDFz2/r-BVap2-FUJdy-AWLDl-AABy-Q-cy6c-I780-transformed.png" alt="Eyewear" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                    <div className="bg-orange-50 rounded-xl">
                        <div className="flex flex-col-reverse items-center lg:flex-row p-7 lg:pr-0 w-full lg:justify-between gap-6 lg:gap-0 min-h-[250px]">
                            ...
                            <div className="h-[300px] lg:h-full lg:w-1/2">
                                <img src="https://i.ibb.co/8NZJ7KR/frying-pan-kitchenware-cookware-and-bakeware-kitchen-utensil-kitchen-transformed.png" alt="Home & Kitchen" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                    <div className="bg-pink-50 rounded-xl">
                        <div className="flex flex-col-reverse items-center lg:flex-row p-7 lg:pr-0 w-full lg:justify-between gap-6 lg:gap-0 min-h-[250px]">
                            ...
                            <div className="h-[300px] lg:h-full lg:w-1/2">
                                <img src="https://i.ibb.co/VCDx7GL/laptop-computer-electronics-multimedia-gadget-national-day-element-transformed.png" alt="Electronics" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
            ...
            <div className="container mx-auto px-4 mb-[120px]">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-orange-400">New Arrivals. <span className="text-[#6B7280]">Discover Our Latest Arrivals</span></h1>
                            ...
                            <div key={product._id}>
                                <div className="card border p-6">
                                    ...
                                    <div className="card-body pb-0 px-0 h-[300px] lg:h-[350px] xl:h-[350px]">
                                        ...
                                        <h4 className=" font-semibold">Brand: <span className="font-medium text-[#6B7280]">{product.brand}</span></h4>
            ...
            <div className="container mx-auto px-4 py-[120px] border-t">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                    <div className="text-center">
                        ...
                        <span className="py-1 px-2 bg-green-300 text-[#0F172A] text-sm font-medium rounded-3xl">Step 1</span>
                        <h1 className="text-base font-semibold text-orange-400 my-4">Filter & Discover</h1>
                        <p className="text-sm font-medium max-w-[250px] mx-auto">Smart filtering and suggestions make it easy to find</p>
                    </div>
                    <div className="text-center">
                        <figure className="w-[120px] md:w-[150px] mx-auto mb-3">
                            <img src="https://i.ibb.co/bgwGzDM/HIW2img-3d1e1bf2693a9272e96a.png" alt="" className="rounded-xl"/>
                        </figure>
                        <span className="py-1 px-2 bg-green-300 text-[#0F172A] text-sm font-medium rounded-3xl">Step 2</span>
                        <h1 className="text-base font-semibold text-orange-400 my-4">Add to bag</h1>
                        <p className="text-sm font-medium max-w-[250px] mx-auto">Easily select the correct items and add them to the cart</p>
                    </div>
                    <div className="text-center">
                        <figure className="w-[120px] md:w-[150px] mx-auto mb-3">
                            <img src="https://i.ibb.co/tBqK9mm/HIW3img-8b344c9a046e6b85a9ab.png" alt="" className="rounded-xl"/>
                        </figure>
                        <span className="py-1 px-2 bg-green-300 text-[#0F172A] text-sm font-medium rounded-3xl">Step 3</span>
                    ...
                    <div className="text-center">
                        ...
                        <span className="py-1 px-2 bg-green-300 text-[#0F172A] text-sm font-medium rounded-3xl">Step 4</span>
                        <h1 className="text-base font-semibold text-orange-400 my-4">Enjoy the product</h1>
                        <p className="text-sm font-medium max-w-[250px] mx-auto">Have fun and enjoy your 5-star quality products</p>
                    </div>
                </div>
            </div>
        </div>
