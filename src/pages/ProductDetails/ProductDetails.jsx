    ...
    return (
        <div className="container mx-auto px-4 my-[120px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-7">
                ...
                <div>
                    <h1 className="text-2xl lg:text-4xl font-medium">{name}</h1>
                    ...
                    <h2 className="font-semibold mt-4">Brand: <span className="font-normal pl-1 text-[#6B7280]">{brand}</span></h2>

                    <p className="font-semibold mt-4">Description: <span className="font-normal pl-1 text-[#6B7280]">{description}</span></p>
                    <div className="flex flex-col min-h-[400px] gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2 lg:gap-6">
                            <div className="bg-green-50 px-4 py-6 rounded-xl">
                                <FaShippingFast className="text-2xl text-black" />
                            ...
                            <div className="bg-blue-50 px-4 py-6 rounded-xl">
                                <GiCirclingFish className="text-2xl text-black" />
                            ...
                            <div className="bg-orange-50 px-4 py-6 rounded-xl">
                                <BsGlobe2 className="text-2xl text-black" />
                            ...
                            <div className="bg-purple-50 px-4 py-6 rounded-xl">
                                <RiRefund2Fill className="text-2xl text-black" />
